...
submitName.addEventListener('click', () => {
  ...
  apologyText.innerHTML = `Aku gak bermaksud bikin kamu merasa bersalah.<br>Maafin aku, ya? 😢`;
});
...
yesBtn.addEventListener('click', () => {
  ...
  popupMsg.textContent = `Aku janji gak bakal bikin kamu merasa bersalah lagi wopyuu++💖🥺✨`;
  generateHearts();
  setTimeout(() => {
